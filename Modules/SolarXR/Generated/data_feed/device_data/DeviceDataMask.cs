...
static public class DeviceDataMaskVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyTable(tablePos, 4 /*TrackerData*/, solarxr_protocol.data_feed.tracker.TrackerDataMaskVerify.Verify, false)
      && verifier.VerifyField(tablePos, 6 /*DeviceData*/, 1 /*bool*/, 1, false)
