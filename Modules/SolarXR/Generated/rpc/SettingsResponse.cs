...
public struct SettingsResponse : IFlatbufferObject
{
  ...
  public static Offset<solarxr_protocol.rpc.SettingsResponse> CreateSettingsResponse(FlatBufferBuilder builder,
    ...
    SettingsResponse.AddVelocitySettings(builder, velocity_settingsOffset);
    SettingsResponse.AddTimeout(builder, timeoutOffset);
    SettingsResponse.AddHidSettings(builder, hid_settingsOffset);
    SettingsResponse.AddStayAligned(builder, stay_alignedOffset);
...
static public class SettingsResponseVerify
{
